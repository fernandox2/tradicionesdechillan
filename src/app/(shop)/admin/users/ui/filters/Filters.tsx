...
export const Filters = ({ placeholder = "Buscar por nombre o email...",  addUserHref = "/admin/users/add" }: Props) => {
  ...
  return (
    <div className="flex items-center space-x-2 sm:space-x-4 mb-6">
      ...
      <Link
        href={addUserHref}
        className="flex items-center justify-center px-3 py-2.5 sm:px-4 sm:py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700 whitespace-nowrap"
      >
