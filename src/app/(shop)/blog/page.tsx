...
export default async function BlogPage({ searchParams: _ }: Props) {
  ...
  const take = parseInt(searchParams.take || "3", 10);
  ...
  return (
    <div className="flex relative flex-col gap-20 items-center justify-start min-h-[1800px] lg:min-h-screen px-5 py-20 max-w-[1440px] mx-auto bg-black/20">
      ...
      <Blog articles={articles as unknown as Article[]} className="absolute top-1/2 transform -translate-y-1/2 lg:ml-40 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl px-5 lg:px-0"/>
